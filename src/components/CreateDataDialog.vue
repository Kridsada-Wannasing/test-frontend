      ...
      <v-card-text>
        <v-container>
          <v-row>
            ...
            <v-col cols="12" md="6">
              <v-text-field label="age" v-model="newData.age"></v-text-field>
            </v-col>
            <v-col cols="12" md="6">
              <v-radio-group v-model="newData.sex" :mandatory="false">
                <v-row>
            ...
            <v-col cols="12" md="6">
              <v-text-field label="tel" v-model="newData.tel"></v-text-field>
            </v-col>
            <v-col cols="12">
              <v-select
                label="status"
            ...
            <v-col cols="12">
              <v-textarea label="remark" v-model="newData.remark"></v-textarea>
            </v-col>
          </v-row>
        </v-container>
      </v-card-text>
